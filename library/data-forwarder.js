...
class DataForwarder {
    ...
    async upload(opts) {
        ...
        let hmacJson = crypto_1.default.createHmac('sha256', this._options.hmacKey);
        ...
        let headers = {
            ...
            'x-file-name': encoding_1.default(opts.filename),
            'Content-Type': 'application/json',
            'Connection': 'keep-alive'
        };
        if (opts.label) {
            headers['x-label'] = encoding_1.default(opts.label);
        }
...
//# sourceMappingURL=data-forwarder.js.map